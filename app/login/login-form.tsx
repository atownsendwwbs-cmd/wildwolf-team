    ...
    <form action={formAction} className="bg-neutral-900 rounded-2xl p-6 space-y-5 border border-neutral-800">
      ...
      <div>
        ...
        <input
          ...
          required
          maxLength={8}
          className="w-full rounded-lg bg-neutral-800 border border-neutral-700 text-white px-3 py-3 text-base tracking-widest focus:outline-none focus:ring-2 focus:ring-orange-500"
          placeholder="****"
        />
      </div>
